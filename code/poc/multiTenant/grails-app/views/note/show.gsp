	...
	<body>
		...
		<div id="show-note" class="content scaffold-show" role="main">
			...
			<ol class="property-list note">
				...
				<g:if test="${noteInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="note.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${noteInstance}" field="description"/></span>
