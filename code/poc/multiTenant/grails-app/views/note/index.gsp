		...
		<div id="list-note" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="description" title="${message(code: 'note.description.label', default: 'Description')}" />
				...
				<g:each in="${noteInstanceList}" status="i" var="noteInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${noteInstance.id}">${fieldValue(bean: noteInstance, field: "description")}</g:link></td>
